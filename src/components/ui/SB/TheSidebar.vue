<template>
  ...
  >
    ...
    <div class="mt-14">
      ...
      />
      <menu-item icon="heroicons-outline:cube" text="Components">
        <template #sub-menu>
          <sub-menu-item text="Icon" />
          <sub-menu-item text="Button" />
          <sub-menu-item text="Dropdown" />
      ...
      <menu-item
        ...
        :route="{ path: '/' }"
      />
      <menu-item icon="heroicons-outline:view-grid" text="Accounts">
        <template #sub-menu>
...
export default {
  ...
  setup(_, { emit }) {
    ...
    const allowSidebarHide = computed(
      () => windowWidth.value < widthBreakpoint
    );
